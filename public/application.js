...
var appUi = __webpack_require__(20);
var appApi = __webpack_require__(11);

var ontoggleCreateSurvey = function ontoggleCreateSurvey(event) {
  appUi.toggleCreateSurvey();
};
var ontoggleDashboard = function ontoggleDashboard(event) {
  appUi.toggleDashboard();
};
var ontoggleSurveyList = function ontoggleSurveyList(event) {
  appUi.toggleSurveyList();
  onGetSurveys();
};

var getQuestionsHTML = function getQuestionsHTML(num) {
  var questionshtml = '';
  for (var i = 0; i < num; i++) {
    questionshtml += "<div id='question'" + (i + 1) + ">" + "<label for='question-title'>Question" + (i + 1) + ":</label>" + "<input type='text' id='question-title' name='survey[questions.question.questionDescription[][" + i + "]] size='50'" + "placeholder='Add question here' required><br>" + "<br>" + "</div>";
  }
...
var onGetSurveys = function onGetSurveys(data) {
  appApi.getSurveys().then(appUi.onGetSurveysSuccess).catch(appUi.onGetSurveysFailure);
};

var onGetUserSurveys = function onGetUserSurveys(id) {
  appApi.getSurveys().then(appUi.onGetUserSurveysSuccess).catch(appUi.onGetUserSurveysFailure);
};

var onCreateSurvey = function onCreateSurvey(event) {
  event.preventDefault();
  var data = getFormFields(this);
  appApi.createSurvey(data).then(appUi.onCreateSurveySuccess).catch(appUi.onCreateSurveyFailure);
};

var onDeleteSurvey = function onDeleteSurvey(event) {
  event.preventDefault();
  var id = $(event.target).data('id');
  appApi.deleteSurvey(id).then(appUi.onDeleteSurveySuccess).then(onGetUserSurveys).catch(appUi.onDeleteSurveyFailure);
};

var onShowUpdate = function onShowUpdate(event) {
  event.preventDefault();
  var id = $(event.target).data('id');
  appApi.getSurvey(id).then(appUi.showUpdateForm);
};

var onUpdateDone = function onUpdateDone(event) {
  event.preventDefault();
  appUi.closeUpdate();
};
...
var onUpdateSurvey = function onUpdateSurvey(event) {
  event.preventDefault();
  var id = store.survey.id;
  var data = getFormFields(this);
  appApi.updateSurvey(data, id).then(appUi.onUpdateSurveySuccess)
...
var onTakeSurvey = function onTakeSurvey(event) {
  event.preventDefault();
  var id = $(event.target).data('id');
  appApi.getSurvey(id).then(appUi.onTakeSurveySuccess)
  // .then(onGetUserSurveys)
  .catch(appUi.onTakeSurveyFailure);
};

var getSurveyResponse = function getSurveyResponse(event) {
  var questions = [];
  var anonymous = store.user ? false : true;
  $('.' + $(event.target).data('id')).each(function (index, ele) {
    questions.push({
...
var onSubmitSurvey = function onSubmitSurvey(event) {
  event.preventDefault();
  var data = getSurveyResponse(event);
  appApi.submitSurvey(data).then(appUi.onSubmitSurveySuccess)
  // .then(onGetUserSurveys)
...
var getSurveys = function getSurveys(data) {
  return $.ajax({
...
var deleteAllSurveyResponses = function deleteAllSurveyResponses(id) {
  return $.ajax({
...
var updateSurvey = function updateSurvey(data, id) {
  var newQuestion = data.survey['questions.question.questionDescription'];
  var newQuestionJson = {
    'survey': {
  ...
  for (var i = 0; i < store.survey.questions.length; i++) {
...
var submitSurvey = function submitSurvey(data) {
  return $.ajax({
...
var getQuestionJson = function getQuestionJson(stuff) {
  var descriptionArray = stuff.survey['questions.question.questionDescription'];
  var optionsArray = stuff.survey['questions.question.options'];
  var activeArray = stuff.survey['questions.question.active'];
  var questionsJson = {
    'survey': {
...
var createSurvey = function createSurvey(stuff) {
  var quesJson = getQuestionJson(stuff);
  return $.ajax({
    url: config.apiOrigin + '/surveys',
    method: 'POST',
    headers: {
...
module.exports = {
  ...
  getSurvey: getSurvey,
  deleteAllSurveyResponses: deleteAllSurveyResponses,
...
var appEvents = __webpack_require__(5);
...
var onSignOut = function onSignOut(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.signOut(data).then(ui.signOutSuccess).then(appEvents.onGetSurveys).catch(ui.signOutFailure);
};
...
var notSamePw = function notSamePw() {
...
var store = __webpack_require__(2);
var showSurveysTemplate = __webpack_require__(21);
var showSurveyTemplate = __webpack_require__(38);
var showSurveyUpdateTemplate = __webpack_require__(39);
var appApi = __webpack_require__(11);

var toggleCreateSurvey = function toggleCreateSurvey() {
...
var toggleDashboard = function toggleDashboard() {
  $('#lndingpg_view_dashboard').removeClass('hidden');
...
var toggleSurveyList = function toggleSurveyList() {
  $('#lndingpg_view_dashboard, #display_survey').addClass('hidden');
...
var onGetSurveysSuccess = function onGetSurveysSuccess(data) {
...
var onGetSurveyFailure = function onGetSurveyFailure() {
...
var getRes = function getRes(id) {
  return new Promise(function (resolve, reject) {
    return appApi.getSurveyResponses(id).then(function (data) {
      resolve(data.surveyresponses);
    }).catch(new Error('some problem'));
  });
};

var getSurveyStatistics = function getSurveyStatistics(responses) {
  var stats = {};
...
var populateStats = function populateStats(survey, stats) {
  var details = '';
  ...
  var _loop = function _loop(k) {
    if (stats[survey.questions[k].id]) {
      ...
      var keys = Object.keys(stats[survey.questions[k].id]);
...
var onGetUserSurveysSuccess = function onGetUserSurveysSuccess(data) {
  ...
  Promise.all(promises).then(function (results) {
    for (var j = 0; j < results.length; j++) {
      if (results[j].length > 0) {
        var stats = getSurveyStatistics(results[j]);
...
var onGetUserSurveyFailure = function onGetUserSurveyFailure() {
...
var showUpdateForm = function showUpdateForm(data) {
  var showSurveyHtml = showSurveyUpdateTemplate({ surveys: data });
...
var closeUpdate = function closeUpdate() {
...
var onUpdateSurveySuccess = function onUpdateSurveySuccess() {
  appApi.deleteAllSurveyResponses(store.survey.id).then(function () {
...
var onTakeSurveySuccess = function onTakeSurveySuccess(data) {
  var showSurveyHtml = showSurveyTemplate({ surveys: data });
...
var onTakeSurveyFailure = function onTakeSurveyFailure() {
...
var onSubmitSurveyFailure = function onSubmitSurveyFailure(error) {
...
module.exports = {
  ...
  onGetSurveysSuccess: onGetSurveysSuccess,
  ...
  onGetUserSurveysSuccess: onGetUserSurveysSuccess,
  onGetUserSurveyFailure: onGetUserSurveyFailure,
  ...
  onTakeSurveyFailure: onTakeSurveyFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div id=\"survey-id\" data-id=\""
    ...
    + "</h5>\n    <button class='take btn-info' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div class=\"container-fluid bg-3\">\n    <div id=\"lndingpg_take_survey\" class=\"row\">\n      <form id='take-survey-form'>\n        <fieldset>\n          <legend>Take Survey - "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "</legend>\n          <br><br>\n"
    + ((stack1 = helpers.each.call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.questions : stack1),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "         <input id=\"take-survey\" data-index=\""
    ...
    + "\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"submit\" class=\"btn btn-primary btn-sm take-survey\" name=\"submit\" value=\"Submit Survey\">\n       </fieldset>\n     </form>\n   </div>\n</div>\n\n";
  ...
  return "          <div data-id=\""
    ...
    + "\">\n            <input type=\"text\" id=\"question\" name=\"question.question.questionDescription\" size=\"50\" placeholder=\""
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.question : stack1)) != null ? stack1.questionDescription : stack1), depth0))
    + "\"><br>\n              <input type=\"radio\" value=\"Strongly&nbsp;Disagree\" name=\"surveyresponse[question.answer[]["
    ...
    + "]]\"> Strongly Disagree<br>\n              <input type=\"radio\" value=\"Disagree\" name=\"surveyresponse[question.answer[]["
    + alias2(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"index","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "]]\"> Disagree<br>\n              <input type=\"radio\" value=\"Neutral\" name=\"surveyresponse[question.answer[]["
    + alias2(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"index","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "]]\"> Neutral<br>\n              <input type=\"radio\" value=\"Agree\" name=\"surveyresponse[question.answer[]["
    + alias2(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"index","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "]]\"> Agree<br>\n              <input type=\"radio\" value=\"Strongly&nbsp;Agree\" name=\"surveyresponse[question.answer[]["
    + alias2(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"index","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "]]\"> Strongly Agree<br>\n            <br>\n         </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div class=\"container-fluid bg-3\">\n    <div id=\"lndingpg_take_survey\" class=\"row\">\n      <form id='take-survey-form'>\n        <fieldset>\n          <legend>Update Survey - "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "</legend>\n          <h4>Please note that adding new questions will eliminate previous responses when the survey is taken again.</h4>\n          <h5>Questions already in your survey.</h5>\n          <br>\n"
  ...
  return "          <div data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n            <input type=\"text\" id=\"question\" name=\"survey[questions.question1.questionDescription]\" size=\"50\" placeholder=\""
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.question : stack1)) != null ? stack1.questionDescription : stack1), depth0))
    + "\" required><br>\n            <input type=\"radio\" value=\"disagree\" disabled> Disagree<br>\n            <input type=\"radio\" value=\"neutral\" disabled> Neutral<br>\n            <input type=\"radio\" value=\"agree\" disabled> Agree<br>\n            <input type=\"radio\" value=\"strongly-agree\" disabled> Strongly Agree<br>\n            <input type=\"hidden\" name=\"survey[questions.question1.active]\" value=\"true\">\n            <br>\n         </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
